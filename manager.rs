...
impl RecipeManager {
    ...
    pub fn update_recipe(&mut self, id: i32 ,name: String, ingredients: Vec<String>, instructions: Vec<String>, servings: u32) -> bool{
    ...
    pub fn delete_recipe(&mut self, id: i32) -> bool{
